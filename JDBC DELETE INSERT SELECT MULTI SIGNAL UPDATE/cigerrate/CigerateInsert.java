...
public class CigerateInsert {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.cj.jdbc.Driver");//class.method
		...
		// String insert = "insert into perfumeinfo
		// values(3,450,'biuebeary','good','good');";
		// String insert = "insert into perfumeinfo values(4,250,'fog','good','good');";
		// String insert = "insert into perfumeinfo
		// values(5,150,'touch','good','good');";
		// String insert = "insert into perfumeinfo
		// values(6,650,'Hugo','good','good');";
		// String insert = "insert into perfumeinfo
		// values(7,950,'Guess','good','good');";
		// String insert = "insert into perfumeinfo
		// values(8,550,'power','good','good');";
		// String insert = "insert into perfumeinfo
		// values(2,3950,'Giorgue','good','good');";
